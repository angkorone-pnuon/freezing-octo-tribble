...
Swipe.prototype = {
    ...
    setup: function () {
        ...
        /*---------------add by matallic.guo section 1---------------*/
        this.element.style.height = "";
        if (index == 0) {
            //            var el = document.createElement("li");
            //            el.style.width = this.width + 'px';
            //            el.style.height = (this.width * 0.45 + 80).toString() + 'px';
            //            el.style.display = 'table-cell';
            //            el.style.verticalAlign = 'top';
            //            this.element.appendChild(el);
            //            this.element.style.width = this.width + 'px';
            this.element.style.height = (this.width * 0.5 + 100).toString() + 'px';
        }
        /*---------------end section 1-------------------------------*/
        ...
        while (index--) {
            ...
            /*---------------add by matallic.guo  section 2----------------*/
            var img = el.children[0].children[0];
            img.style.height = (this.width * 0.5).toString() + 'px';
            /*---------------end section 2---------------------------------*/
